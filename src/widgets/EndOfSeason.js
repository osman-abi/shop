    ...
    return (
        <Row className="section-ptb section-1 align-items-center">
            ...
            <div className="section-title text-md-right">
                <h2 className="title text-right"> Sezon sonu</h2>
                <p>Yeni kateqoriyalardakı endirimlərdən faydalanın və inanılmaz təkliflərdən xəbərdar olun</p>
            ...
            <div className="ciyashop_button_wrapper ciyashop_button_width_default">
                ...
                <Link to="/shop"> Alişverişə başla </Link>
                </div>
            </div>
            </Col>
