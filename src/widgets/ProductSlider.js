                                                    ...
                                                    <div className="product-actions-inner">
                                                        <div className="product-action product-action-add-to-cart">
                                                               {!CheckCardItem(product.id) ? 
                                                                    <Link onClick={() => AddToCart(product.id,product.name, product.pictures[0], 1, product.salePrice, "In Stock")} className="button add_to_cart_button" rel="nofollow">Səbətə əlavə et</Link>
                                                                : 
                                                        ...
                                                        <div className="product-action product-action-wishlist">
                                                            {!CheckWishList(product.id) ? 
                                                                <Link onClick={()=>AddToWishList(product.id,product.name,product.pictures[0],1,product.salePrice,"In Stock")} className="add_to_wishlist" data-toggle="tooltip" data-original-title="Wishlist" data-placement="top"> Seçilmişlərə əlavə et </Link>
                                                            :
